...
addScores = =>
    analytics.db.collection("posttest").find(type: "proberesponse").toArray (err, proberesponses) =>
    ...
    (err, people) =>
        for person in people
            ...
            if person.email in students
                ...
                api.db.collection("grade").save points: person.score, grade: grade, email: person.email, title: "Posttest"
