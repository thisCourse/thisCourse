...
reset_finals = =>
    undergrads.forEach reset_user_final
    # undergrads.forEach compare_points
setTimeout reset_finals, 10000
...
reset_user_final = (email) =>
    ...
    analytics.get_student_nugget_attempts email, (err, claimednuggets) =>
        ...
        alternate_key = "final-alternate:" + email
