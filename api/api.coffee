...
class MongoCollection
    ...
    retrieveDocumentById: (callback) =>
        @query = _id: db.ObjectID(@req.params.id.toString())
    ...
    expandModelsByPath: (callback, model, path) =>
        ...
        for key,i in path
            ...
            if newmod is undefined # subkey could not be found
                ...
                query = _id: db.ObjectID(model.id.toString())
    ...
    process_POST_array: (callback) =>
        ...
        if @data instanceof Array
            ...
            @data._id or= new db.ObjectID # new object's _id won't be autogenerated; need to do it manually
    ...
    process_POST_object: (callback) => 
        @data._id = @object._id or new db.ObjectID
